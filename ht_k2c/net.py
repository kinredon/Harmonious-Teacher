...
from cvpods.modeling.backbone.fpn import build_retinanet_resnet_fpn_backbone, build_retinanet_vgg_fpn_backbone
...
def build_backbone(cfg, input_shape=None):
    ...
    if cfg.MODEL.BACKBONE.NAME == 'vgg':
        backbone = build_retinanet_vgg_fpn_backbone(cfg, input_shape)
    else:
