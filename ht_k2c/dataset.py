...
from cvpods.data.datasets import CityDataset, FoggyDataset, Sim10kDataset, KITTIDataset, CityCarDataset, City7clsDataset, Bdd100kDataset
...
class FullCity7cls(City7clsDataset):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'city7cls_train')
...
class UnlabledCityCar(CityCarDataset):
    def __init__(self):
        from cvpods.configs import BaseDetectionConfig as DetCfg
        super().__init__(DetCfg(), 'citycar_train')
