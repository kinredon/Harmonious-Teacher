...
from .paths_route import _PREDEFINED_SPLITS_CITY7CLS
...
@DATASETS.register()
class City7clsDataset(BaseDataset):
    def __init__(self, cfg, dataset_name, transforms=[], is_train=True):
        super(City7clsDataset, self).__init__(cfg, dataset_name, transforms, is_train)

        image_root, split = _PREDEFINED_SPLITS_CITY7CLS["voc"][self.name]
    ...
    def _get_metadata(self):
        # fmt: off
        thing_classes = ('person', 'rider', 'car', 'truck', 'bus', 'motorcycle', 'bicycle')
        meta = {
            "thing_classes": thing_classes,
            "evaluator_type": _PREDEFINED_SPLITS_CITY7CLS["evaluator_type"]["voc"],
