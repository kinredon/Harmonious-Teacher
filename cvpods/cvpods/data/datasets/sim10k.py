...
from .paths_route import _PREDEFINED_SPLITS_SIM10K
...
@DATASETS.register()
class Sim10kDataset(BaseDataset):
    def __init__(self, cfg, dataset_name, transforms=[], is_train=True):
        super(Sim10kDataset, self).__init__(cfg, dataset_name, transforms, is_train)

        image_root, split = _PREDEFINED_SPLITS_SIM10K["voc"][self.name]
    ...
    def _get_metadata(self):
        ...
        meta = {
            ...
            "evaluator_type": _PREDEFINED_SPLITS_SIM10K["evaluator_type"]["voc"],
