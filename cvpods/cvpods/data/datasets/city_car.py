...
from .paths_route import _PREDEFINED_SPLITS_CITY_CAR
...
@DATASETS.register()
class CityCarDataset(BaseDataset):
    def __init__(self, cfg, dataset_name, transforms=[], is_train=True):
        super(CityCarDataset, self).__init__(cfg, dataset_name, transforms, is_train)

        image_root, split = _PREDEFINED_SPLITS_CITY_CAR["voc"][self.name]
    ...
    def _get_metadata(self):
        ...
        meta = {
            ...
            "evaluator_type": _PREDEFINED_SPLITS_CITY_CAR["evaluator_type"]["voc"],
