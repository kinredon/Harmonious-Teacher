...
from .paths_route import _PREDEFINED_SPLITS_BDD100K
...
class Bdd100kDataset(BaseDataset):
    def __init__(self, cfg, dataset_name, transforms=[], is_train=True):
        super(Bdd100kDataset, self).__init__(cfg, dataset_name, transforms, is_train)

        image_root, split = _PREDEFINED_SPLITS_BDD100K["voc"][self.name]
    ...
    def _get_metadata(self):
        ...
        meta = {
            ...
            "evaluator_type": _PREDEFINED_SPLITS_BDD100K["evaluator_type"]["voc"],
