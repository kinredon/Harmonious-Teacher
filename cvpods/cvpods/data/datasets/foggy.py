...
from .paths_route import _PREDEFINED_SPLITS_FOGGY
...
@DATASETS.register()
class FoggyDataset(BaseDataset):
    def __init__(self, cfg, dataset_name, transforms=[], is_train=True):
        super(FoggyDataset, self).__init__(cfg, dataset_name, transforms, is_train)

        image_root, split = _PREDEFINED_SPLITS_FOGGY["voc"][self.name]
    ...
    def _get_metadata(self):
        ...
        meta = {
            ...
            "evaluator_type": _PREDEFINED_SPLITS_FOGGY["evaluator_type"]["voc"],
