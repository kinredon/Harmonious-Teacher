...
class PascalVOCDetectionEvaluator(DatasetEvaluator):
    ...
    def evaluate(self):
        ...
        ap50_small_table = create_small_table(ap50)
        logger.info("Evaluation results for bbox (per-category): \n" + ap50_small_table)
        ret["bbox"].update({"class-AP50": ap50})
